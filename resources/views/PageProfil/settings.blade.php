...
<div class="container my-5">
  <form class="form-contact contact_form" action="{{route('settings.update', $users->id)}}" method="post"  enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    @if(Auth::check() && Auth::user()->role_id ==4)
      ...
      <div class="col-sm-6">
          <div class="form-group">
              <label for="">Nom :</label>
            <input class="form-control @error('nom') is-invalid @enderror" name="nom" id="nom" type="text" maxlength="15" placeholder="Nom" value="{{$users->nom}}">
          </div>
          @error('nom')  
