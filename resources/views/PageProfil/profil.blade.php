...
<body>
    ...
    <div class="main-container profil">
        ...
        <!-- LEFT-CONTAINER -->
        <div class="left-container containerprofil">
        ...
        <!-- MIDDLE-CONTAINER -->
        <div class="middle-container containerprofil">
        ...
        <!-- RIGHT-CONTAINER -->
        <div class="right-container containerprofil">
            ...
            <div class="account block"> <!-- ACCOUNT (RIGHT-CONTAINER) -->
                ...
                <a class="sign-in buttonpro" href="#22">SIGN IN</a>
            ...
            <div class="calendar-day block"> <!-- CALENDAR DAY (RIGHT-CONTAINER) -->
                <div class="arrow-btn-container">
                    ...
                    <a class="add-event buttonpro" href="#27">ADD EVENT</a>
            </div>
